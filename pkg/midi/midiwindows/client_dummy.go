...
// ClientMidDummy is a dummy implementation of the ClientMIDI interface for non-Windows systems.
...
func NewMIDIClient(logger logger.Logger) (midi.ClientMIDI, error) {
	logger.Info("Using dummy MIDI client for non-Windows system")
